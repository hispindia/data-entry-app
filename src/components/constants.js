...
const USER_GROUPS = {
  FACILITY: "BNu4OhgqM9M",
  STATE_REGION: "CGwnLihmbJE",
  TOWNSHIP: "wwaN4pq55hA"
}
const BIRTH_PROGRAM = "cUjoGJK4gPL";
const DATAELEMENT_INFANT_NAME = "R43kdns3YYL";
const DATAELEMENT_BIRTH_DATE = "zAetLzp3cT1";
const DATAELEMENT_DEATH_DATE= "jGGNvNYhu47";
const DATAELEMENT_FATHER_NRC= "sbJu1PyDWfd";
const DATAELEMENT_MOTHER_NRC= "eCxn2AtJ3eG";
const DATAELEMENT_NRC= "O4Ewq2OkyL1";
...
export {
  ...
  USER_GROUPS,
  BIRTH_PROGRAM,
  DATAELEMENT_INFANT_NAME,
  DATAELEMENT_BIRTH_DATE,
  DATAELEMENT_DEATH_DATE,
  DATAELEMENT_FATHER_NRC,
  DATAELEMENT_MOTHER_NRC,
  DATAELEMENT_NRC,
  PROGRAM_RULE_TYPES,
  LANGUAGES,
  LANGUAGES_SSR,
