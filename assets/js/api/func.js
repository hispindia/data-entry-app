import { eventApi, dataElementApi, meApi, organisationUnitGroup, attributeApi, constantsApi, maCommencedApi } from './DataApi.js';
...
export async function getCommencedLength() {
  return await maCommencedApi.get();
}
