...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function fetchEvents() {
    ...
    tei.programStage = programStage.totalIncome;
    tei.year = {
      ...tei.year,
    ...
    if (data.trackedEntityInstances && data.trackedEntityInstances.length > 0) {
      ...
      const dataValuesEC = getProgramStageEvents(filteredPrograms, programStage.projectExpenseCategory , program.projectExpenseCategory , dataElements.year.id) //data vlaues year wise
