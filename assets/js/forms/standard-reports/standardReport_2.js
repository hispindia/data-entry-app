...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  async function renderTable() {
    ...
    const childHeaders = [
      ...
      { name: "Country of Registration", color: "#1e558e"}, //not found
      { name: "Organisation Type", color: "#1e558e", id: "U7L75bi4oNF"}, 
      ...
      { name: "Domains", color: "#1e558e"}, //NOT FOUND
      { name: "Country Income Status", color: "#1e558e", id: "uA6aKCAdLYK"},
      { name: "SOI-OAC Eligible", color: "#1e558e", id: "F1o8DPRlbki"},
      ...
      { name: "Board Member (Secretary) – Relevant Position Available", color: "#006f60"},
      ...
      { name: "Board Member (Secretary) – Contact Number", color: "#006f60", id: "gyvjaCqILkw"},
      ...
      { name: "Board Member (Treasurer) – Relevant Position Available?", color: "#6f2c91", id: ""}, //Not found
      ...
      { name : "BOARD MEMBER – YOUTH", color: "#e35205", id: ""}, //not found
      ...
      { name: "Senior Management (ED/CEO/Director General) – UIN / Tax ID / National ID", color: "#4b5e65", id: "abcdefghijkl"},
      ...
      { name: "Senior Management (Director of Programs) – Relevant Position Available?", color: "#2e7e3c"}, //not found
      ...
      { name: "Senior Management (Director of Programs) – Justification for Vacant Position", color: "#2e7e3c", }, //not found
      { name: "Senior Management (Director of HR) – Relevant Position Available?", color: "#006f60"},
      ...
      { name: "Senior Management (Director of Organisation, Learning and Evaluation) – Full Name", color: "#6f2c91", id: "TfCXfVv6j2O"},
