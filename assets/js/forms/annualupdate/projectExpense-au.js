      ...
      >
        ...
        <div class="form-row">
          ...
          Comments</span> (<small class="text-muted ml-1" data-i18n="intro.optional">optional</small>)
            ...
            ${maxWords- (dataValues[dataElements.projectExpenseCategory[index].comment] ? dataValues[dataElements.projectExpenseCategory[index].comment].trim().split(/\s+/).length: 0)}</span>
